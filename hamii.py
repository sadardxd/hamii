...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.0.0                     \033[1;31m   │
...
def my_tool_security():
    ...
    my_server=requests.get("https://www.facebook.com/100048572089584/posts/pfbid02VJ3UdBSWXStdP3ykuKPdFeL6XXzkVsJE2Xp2hMoRYXXUmH4DqnUsGYMvWWbZmceHl/?app=fbl").text
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp 03***** \n")
...
def xyz():
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/ehtashamsadar");xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+923******")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
